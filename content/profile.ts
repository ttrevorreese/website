...
export const profile: Profile = {
  name: "Trevor Reese",
  tagline: "Photographer · Developer",
  bio: [
    // [REPLACE] Replace these paragraphs with your own words
    "I'm Trevor — a software engineer and travel photographer based in Murrieta, California. I build things for the web and capture the world through a lens.",
